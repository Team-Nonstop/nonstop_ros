...
#ifndef NONSTOP_AR_POSE_AR_MULTI_H
#define NONSTOP_AR_POSE_AR_MULTI_H
...
#include <nonstop_ar_pose/ARMarkers.h>
#include <nonstop_ar_pose/ARMarker.h>
#include <nonstop_ar_pose/object.h>

std::string cameraName_ = "/camera";
std::string cameraImageTopic_ = cameraName_ + "/image_raw";
std::string cameraInfoTopic_  = cameraName_ + "/camera_info";
...
namespace nonstop_ar_pose
{
  ...
  private:
    ...
    nonstop_ar_pose::ARMarkers arPoseMarkers_;
    int threshold_;
    bool getCamInfo_;
    bool publishTf_;
